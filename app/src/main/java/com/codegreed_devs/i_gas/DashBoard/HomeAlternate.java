...
public class HomeAlternate extends Fragment {

    ImageView cardViewBuyGas, cardViewRefillGas, cardViewGasEquipments, cardViewBulkPurchase;
    String GasBurner = "";
    String GasGrill = "";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        //Return alternate home screen for android version 5 and below
        return inflater.inflate(R.layout.fragment_home_alternate, container, false);
    }
